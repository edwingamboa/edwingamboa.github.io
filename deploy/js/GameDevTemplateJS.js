...
function create() {
  ...
  //The score
  scoreText = game.add.text(game.camera.width - 300, 16, 'Score: 0',
  {fontSize: '32px', fill: '#000'});
  scoreText.fixedToCamera = true;

  //The ammo
  ammoText = game.add.text(game.camera.width - 300, game.world.height - 50,
  'Ammo: 0', {fontSize: '32px', fill: '#000'});
  ammoText.fixedToCamera = true;

  //The health level
  healthLevelText = game.add.text(16, 16, 'Health: 100', {fontSize: '32px',
      fill: '#000'});
  ...
  inventoryButton = game.add.button(game.camera.width - 50, 100,
  'inventory_button', displayInventory, this);
...
Weapon.prototype.fire = function() {
  ...
  if (this.game.time.now > this.nextFire) {
    ...
    if (currentBullet && this.numberOfBullets > 0) {
      ...
      currentBullet.body.velocity.x = this.player.body.velocity.x +
              this.bulletSpeed * xDirection;
